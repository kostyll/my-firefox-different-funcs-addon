...
download_sdk:
	rm ~/jetpack -rf
	wget https://ftp.mozilla.org/pub/mozilla.org/labs/jetpack/jetpack-sdk-latest.tar.gz -O ~/jetpack-sdk-latest.tar.gz
	mkdir ~/jetpack
	tar zxvf ~/jetpack-sdk-latest.tar.gz -C ~/jetpack
